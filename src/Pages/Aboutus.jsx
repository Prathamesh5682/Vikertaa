    ...
    return (
        <div className="flex flex-col justify-center items-center px-4">
            ...
            <div className="text-center mt-12">
                ...
                <p className="mt-4 text-lg md:text-lg ml-44 mr-44">
            ...
            <div className="flex flex-col md:flex-row w-full justify-center items-center mt-10 mb-10 p-4">
                <div className="mt-10 w-full md:w-1/2 text-center md:text-left md:ml-8">
                    <h1 className="text-green-400 lg:ml-28 sm:ml-0 md:ml-0 text-2xl">OUR FOUNDING STORY</h1>
                    <p className="text-xl lg:ml-28 sm:ml-0 md:ml-0 mt-4 text-justify">
                        ...
                        auctions and wanted to build a place where anyone, from small sellers to big businesses, could
            ...
            <div className="flex flex-col md:flex-row w-full md:w-[80%] justify-center items-center mt-18 mb-10 p-4">
                {/* Vision Section */}
